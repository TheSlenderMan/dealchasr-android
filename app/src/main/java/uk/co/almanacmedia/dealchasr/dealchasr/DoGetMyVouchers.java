...
public class DoGetMyVouchers extends AsyncTask<Void,Void,String> {

    private Exception exception;
    private String API_URL = "http://api.almanacmedia.co.uk/users/vouchers";
    ...
    ArrayList<VoucherRecyclerModel> voucherList;
    public static final String PREFS_NAME = "DealSpotr.Data";

    public DoGetMyVouchers(Context context, Integer userID, View v, RecyclerView recyclerView){
    ...
    protected void onPreExecute(){
        ...
        voucherList = new ArrayList<VoucherRecyclerModel>();
    }
        ...
        if(json != null){
            try {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    Integer voucherID = jo.getInt("id");
                    String voucherName = jo.getString("voucherName");
                    String dealName = jo.getString("dealName");
                    String dealDescription = jo.getString("voucherDescription");
                    String voucherTime = jo.getString("endDate");
                    String voucherCount = jo.getString("voucherCount");
                    String venueName = jo.getString("vName");

                    voucherList.add(new VoucherRecyclerModel(voucherName, dealName, dealDescription, voucherID, voucherTime, venueName, voucherCount));
                }


                VoucherRecyclerAdapter recyclerAdapter = new VoucherRecyclerAdapter(context, voucherList);
